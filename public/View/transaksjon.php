...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#sok").click(function(){
            ...
            var url = "../hentTransaksjoner.php?fraDato="+fraDato+"&tilDato="+tilDato+"&kontoNr="+kontoNr;
            $.getJSON(url,function(data)
            {
                if(data ==="Feil innlogging")
                {
    ...
    <p>Velg fra og til dato for å vise transaksjoner fra konto</p>
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="fraDato">
            </div>
            <div class="col-md-3">
                <label >Til dato:</label>
                <input type="text" class="form-control" id="tilDato">
            </div>
        </div>
        <br/>
