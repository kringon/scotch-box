...
<script type="text/javascript">
    ...
    function formaterKontoData(jsonData){
        ...
        $.each(jsonData, function( key, konto) {
            ...
            tabell+="<tr>";
            tabell+="<td><input type='text' readonly id='kontonummer"+linje+"' size='11' value='"+konto.Kontonummer+"'/></td>";
            ...
            tabell+="<td><input type='text' id='personnummer"+linje+"' size='11' value='"+konto.Personnummer+"'/></td>";
